...
echo "Creating gemini posts output directory $workdir/$public_dir/$gemini_output_dir/posts"
mkdir "$workdir/$public_dir/$gemini_output_dir/posts"
...
echo "Moving $workdir/$public_dir/posts/gemini/index.gmi to $workdir/$public_dir/$gemini_output_dir/posts/index.gmi"
mv "$workdir/$public_dir/posts/gemini/index.gmi" "$workdir/$public_dir/$gemini_output_dir/posts/"
echo "Moving Posts RSS files:"
mv "$workdir/$public_dir/posts/index.xml" "$workdir/$public_dir/$gemini_output_dir/posts/index.xml"
...
echo "$workdir/$public_dir/posts/gemini"
